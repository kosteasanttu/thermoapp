...
<body>
	...
	<div id="wrapper">
        ...
        $query = "SELECT DISTINCT patients.ssn, patients.name, patients.location, max(temperature.value)AS value,max(temperature.date) FROM patients LEFT JOIN temperature ON patients.ssn = temperature.ssn GROUP BY patients.ssn ORDER BY `temperature`.`value` DESC";        
